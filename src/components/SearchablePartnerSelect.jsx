...
const SearchablePartnerSelect = ({ partners = [], value, onChange, onAddNew, placeholder = "بحث عن شريك..." }) => {
              ...
              {filtered.length > 0 ? filtered.map(p => (
                <div 
                  ...
                  className={cn(
                    ...
                    value === p.id ? "bg-blue-50 text-blue-700 font-bold" : "hover:bg-slate-50 text-slate-700"
                  )}
                ...
                >
                   <div className="flex flex-col">
                      ...
                      <span className="opacity-70 font-mono text-[10px]">{p.phone1}</span>
                   </div>
                   {value === p.id && <Check className="w-3.5 h-3.5" />}
                </div>
              )) : (
...
export default SearchablePartnerSelect;
